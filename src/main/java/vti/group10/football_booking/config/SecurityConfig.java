    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/", "/api/auth/**", "/api/payment/momo/ipn", "/api/webhook/sepay").permitAll()
                    .requestMatchers("/api/profile/update").authenticated()
                    .requestMatchers("/clusters/**").permitAll()
                    .requestMatchers("/owner/clusters/**").hasAnyRole("OWNER", "ADMIN")
                    .requestMatchers("/admin/clusters/**").hasRole("ADMIN")
